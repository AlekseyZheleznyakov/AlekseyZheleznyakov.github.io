export const d2r = (x: number) => {
    return x * Math.PI / 180;
};

export const r2d = (x: number) => {
    return x * 180 / Math.PI;
};

export function determ3x3(a00: number, a01: number, a02: number,
...
export class mat4 {
    ...
    setFrustum(l: number, r: number, b: number, t: number, n: number, f: number) {
...
export function matrScale(v: vec3) {
    return new mat4().setScale(v);
}

export function matrTranslate(v: vec3) {
    return new mat4().setTranslate(v);
}

export function matrRotateX(angle: number) {
    return new mat4().setRotateX(angle);
}

export function matrRotateY(angle: number) {
    return new mat4().setRotateY(angle);
}

export function matrRotateZ(angle: number) {
    return new mat4().setRotateZ(angle);
}

export function matrRotate(v: vec3, angle: number) {
    return new mat4().setRotate(v, angle);
}

export function vec3Set(...args: number[]) {
        if (args.length == 1) {
            let x = arguments[0];
